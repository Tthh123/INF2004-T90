...
float Kp_right = 0.1, Ki_right = 0.01, Kd_right = 0.05;
...
float error_left = 0, integral_left = 0, derivative_left = 0,
      last_error_left    = 0;
float target_speed_right = 10.0; // Set your target speeds here
float target_speed_left  = 10.0;
...
init_pins()
{
    ...
    pwm_set_wrap(0, 12500);
    pwm_set_chan_level(0, PWM_CHAN_A, 12500);
    pwm_set_chan_level(0, PWM_CHAN_B, 12500);
